    ...
    return (
        <div className={styles.welcome}>
            ...
            <div className={styles.buttons}>
                ...
                <button className={styles.add_amount}>Add Amount</button>
                <button className={styles.add_async}>Add Async</button>
            </div>
